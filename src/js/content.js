...
const CONTENT = {
  ru: {
    ...
    nav: {
      personal: "жизнь",
      // «резюме», а не «работа»: таб — первое, что видит человек, попавший на
      // корень, и единственное место наверху, где страница может назвать себя.
      // EN остаётся «job» — там «CV» бытовое слово, этой проблемы нет.
      cv: "резюме",
    },
