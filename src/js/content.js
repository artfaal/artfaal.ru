...
//
// Обе страницы (index.html, cv.html) загружают этот файл.
    ...
    personal: {
      ...
      about: {
        ...
        body: [
          ...
          "6+ лет строю инфраструктуру для enterprise-продуктов. Сейчас — DevOps-инженер на проекте Jet Detective, антифрод-платформе для банков и ритейла. Отвечаю за всё: от CI/CD и мониторинга до управления 160+ виртуальными машинами.",
      ...
      value: {
        ...
        items: [
          ...
          },
          {
            ...
            d: "Инфраструктура, дебаг, оркестрация. Умею разруливать сложные техконтексты один — от диагностики до production fix.",
          },
          {
            k: "04",
          ...
          },
          {
            ...
            d: "Глубоко изучаю LLM-агентов и их применение в инженерных процессах. Помогаю командам сшивать это без боли.",
          },
          {
            k: "06",
        ...
        cards: [
          {
            ...
            tag: "книги",
            img: "assets/cosmere.png",
          },
          {
            t: "Мотоцикл",
            d: "Как способ прочистить голову и переключиться.",
            tag: "мотоцикл",
            img: "assets/moto.jpeg",
          },
          {
            t: "3D-принтер",
            d: "Проектирую маленькие прикладные проекты для дома. Кастомная подставка для электронной книги? Почему бы и нет.",
            tag: "3D / CAD",
            img: "assets/printer_01.jpeg",
          },
          {
            t: "Спортзал",
            d: "Три года регулярно. Получил второй разряд по жиму лёжа на соревнованиях. Надеюсь дотянуть до мастера спорта.",
            tag: "спорт",
            img: "assets/gum.PNG",
          },
          {
            t: "Аниме, игры, попкультура",
            d: "Аниме как способ переключиться. На игры всё меньше времени, но продолжаю следить и стараюсь находить.",
            tag: "жизнь",
            img: "assets/anime-games.jpeg",
          },
        ],
      },
        ...
        items: [
          {
            ...
            d: "Глубоко погрузился в тему: ~300 часов на изучение OpenClaw и агентных фреймворков. Ищу способы реально снять когнитивную нагрузку с инженерных процессов.",
          },
          {
